...
export const EVENTS: SoccerEvent[] = [
  ...
  {
    id: 'evt-jun12-festival-day01',
    date: '2026-06-12',
    time: '12:00',
    title: 'Fan Festival · Day 1 (Preview)',
    venueId: 'city-hall-plaza',
    venueName: 'Boston City Hall Plaza',
    timeBucket: 'afternoon',
    category: 'fan-festival',
    description: 'Soft opening day. Festival village preview, food vendors, big-screen calibration. 16 days of free programming begin tomorrow.',
  },
  {
    id: 'evt-jun13-festival-day02',
    date: '2026-06-13',
    time: '11:00',
    title: 'Fan Festival · Day 2 (Grand Opening)',
    venueId: 'city-hall-plaza',
    venueName: 'Boston City Hall Plaza',
    timeBucket: 'morning',
    category: 'fan-festival',
  ...
  {
    id: 'evt-jun14-festival-day03',
    date: '2026-06-14',
    time: '12:00',
    title: 'Fan Festival · Day 3',
    venueId: 'city-hall-plaza',
    venueName: 'Boston City Hall Plaza',
    timeBucket: 'afternoon',
    category: 'fan-festival',
    description: 'Sunday family day. Skills clinics, face painting, multi-screen group-stage viewing.',
  },
  {
    id: 'evt-jun15-festival-day04',
    date: '2026-06-15',
    time: '12:00',
    title: 'Fan Festival · Day 4',
    venueId: 'city-hall-plaza',
    venueName: 'Boston City Hall Plaza',
    timeBucket: 'afternoon',
    category: 'fan-festival',
    description: 'Monday afternoon and evening matches on the big screen. Food trucks rotate weekly.',
  },
  {
  ...
  {
    id: 'evt-jun16-festival-day05',
    date: '2026-06-16',
    time: '12:00',
    title: 'Fan Festival · Day 5 (Match Day)',
    venueId: 'city-hall-plaza',
    venueName: 'Boston City Hall Plaza',
    timeBucket: 'afternoon',
    category: 'fan-festival',
    description: 'Match Day in Foxboro. Festival hosts simultaneous big-screen viewing for fans who can\'t make it to Gillette.',
  },
  {
  ...
  {
    id: 'evt-jun17-festival-day06',
    date: '2026-06-17',
    time: '12:00',
    title: 'Fan Festival · Day 6',
    venueId: 'city-hall-plaza',
    venueName: 'Boston City Hall Plaza',
    timeBucket: 'afternoon',
    category: 'fan-festival',
    description: 'Mid-week programming · panel talks, Boston soccer history exhibition.',
  },
  {
    id: 'evt-jun18-festival-day07',
    date: '2026-06-18',
    time: '12:00',
    title: 'Fan Festival · Day 7',
    venueId: 'city-hall-plaza',
    venueName: 'Boston City Hall Plaza',
    timeBucket: 'afternoon',
    category: 'fan-festival',
    description: 'Soccer journalism live shows in the festival pavilion · big-screen evening match.',
  },
  {
  ...
  {
    id: 'evt-jun19-festival-day08',
    date: '2026-06-19',
    time: '12:00',
    title: 'Fan Festival · Day 8 (Match Day)',
    venueId: 'city-hall-plaza',
    venueName: 'Boston City Hall Plaza',
    timeBucket: 'afternoon',
    category: 'fan-festival',
    description: 'Friday match day. Free big-screen viewing for the Gillette match · expected peak weekend crowd starts here.',
  },
  {
    id: 'evt-jun20-festival-day09',
    date: '2026-06-20',
    time: '11:00',
    title: 'Fan Festival · Day 9 (Saturday Peak)',
    venueId: 'city-hall-plaza',
    venueName: 'Boston City Hall Plaza',
    timeBucket: 'morning',
    category: 'fan-festival',
    description: 'Highest crowd day of the festival. All-day programming · youth tournament finale · evening concert.',
  },
  {
    id: 'evt-jun21-festival-day10',
    date: '2026-06-21',
    time: '11:00',
    title: 'Fan Festival · Day 10',
    venueId: 'city-hall-plaza',
    venueName: 'Boston City Hall Plaza',
    timeBucket: 'morning',
    category: 'fan-festival',
    description: 'Sunday family programming. Soccer skills clinics with NEOTHSL coaches in the morning.',
  },
  {
    id: 'evt-jun22-festival-day11',
    date: '2026-06-22',
    time: '12:00',
    title: 'Fan Festival · Day 11',
    venueId: 'city-hall-plaza',
    venueName: 'Boston City Hall Plaza',
    timeBucket: 'afternoon',
    category: 'fan-festival',
    description: 'Monday programming · live music sessions and screening of the day\'s group-stage match.',
  },
  {
  ...
  {
    id: 'evt-jun23-festival-day12',
    date: '2026-06-23',
    time: '11:00',
    title: 'Fan Festival · Day 12 (Match Day)',
    venueId: 'city-hall-plaza',
    venueName: 'Boston City Hall Plaza',
    timeBucket: 'morning',
    category: 'fan-festival',
    description: 'Match day · early kickoff means morning programming starts at the festival. Coffee + soccer.',
  },
  {
    id: 'evt-jun24-festival-day13',
    date: '2026-06-24',
    time: '12:00',
    title: 'Fan Festival · Day 13',
    venueId: 'city-hall-plaza',
    venueName: 'Boston City Hall Plaza',
    timeBucket: 'afternoon',
    category: 'fan-festival',
    description: 'Mid-week programming · soccer culture panel and exhibition tournament.',
  },
  {
    id: 'evt-jun25-festival-day14',
    date: '2026-06-25',
    time: '12:00',
    title: 'Fan Festival · Day 14',
    venueId: 'city-hall-plaza',
    venueName: 'Boston City Hall Plaza',
    timeBucket: 'afternoon',
    category: 'fan-festival',
    description: 'Thursday · panel discussions on the global game · final-three-days countdown begins.',
  },
  {
  ...
  {
    id: 'evt-jun26-festival-day15',
    date: '2026-06-26',
    time: '12:00',
    title: 'Fan Festival · Day 15 (Match Day)',
    venueId: 'city-hall-plaza',
    venueName: 'Boston City Hall Plaza',
    timeBucket: 'afternoon',
    category: 'fan-festival',
    description: 'Final group-stage Friday · big-screen viewing of the Foxboro match · weekend programming begins.',
  },
  {
    id: 'evt-jun27-festival-day16',
    date: '2026-06-27',
    time: '11:00',
    title: 'Fan Festival · Day 16 (Closing)',
    venueId: 'city-hall-plaza',
    venueName: 'Boston City Hall Plaza',
    timeBucket: 'morning',
    category: 'fan-festival',
    description: 'Final day of the official Fan Festival. Closing concert in the evening · ~5K visitors expected.',
  },
  {
